...
public class SentenceWordCountTopology {
  ...
  static class SplitSentenceBolt extends BaseRichBolt{
	...
	// To output tuples from this bolt to the next stage bolts, if any
	  ...
	  public void execute(Tuple tuple) {
		  ...
		  for(String word: sentence.split(delims)) {
	  ...
	  @Override
	  public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
		  outputFieldsDeclarer.declare(new Fields("sentance-word"));
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("split-sentance-bolt", new SplitSentenceBolt(), 15).shuffleGrouping("sentence-spout");
    builder.setBolt("count-bolt", new CountBolt(), 15).fieldsGrouping("split-sentance-bolt", new Fields("sentance-word"));
